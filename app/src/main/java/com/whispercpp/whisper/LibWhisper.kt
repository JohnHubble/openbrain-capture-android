...
data class TranscriptionResult(val text: String, val maxNoSpeechProb: Float)
...
class WhisperContext private constructor(private var ptr: Long) {
    ...
    suspend fun transcribeData(data: FloatArray, printTimestamp: Boolean = true): String =
        transcribeDataWithSpeechProb(data, printTimestamp).text

    suspend fun transcribeDataWithSpeechProb(
        data: FloatArray,
        ...
        val text = buildString {
            for (i in 0 until textCount) {
                val nsp = WhisperLib.getTextSegmentNoSpeechProb(ptr, i)
        ...
        return@withContext TranscriptionResult(text, maxNoSpeech)
    }
